...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Always enable RLS on tables, as this is standard Postgres
        DB::unprepared('
        ...
        $hasAuth = DB::select("SELECT 1 FROM information_schema.schemata WHERE schema_name = 'auth'");
        
        if (empty($hasAuth)) {
            return; // Skip Supabase-specific policies and triggers
        }
